...
class GempaTerkini:
    ...
    def ekstraksi_data(self): #fungsi yang tidak menerima argumen atau parameter, mengolah data dari BMKG.go.id
...
if __name__ == '__main__':
    ...
    print('deskripsi package', gempa_di_dunia.description)
    gempa_di_dunia.run()
